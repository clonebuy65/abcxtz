...
const weekendMessages = [
  {
    timer: '9:00:00 AM',
    saturdayMessage: [
    'Đã cuối tuần rồi sao, thay mặt admin Milo. Bot xin chúc tất cả mọi người trong box có 1 ngày cuối tuần thật vui vẻ!', 
      
    'Bận rộn cả tuần cũng có được ngày nghỉ, tớ là bot xin chúc tất cả mọi người có 1 ngày nghỉ hạnh phúc bên gia đình và người thân<3',

    'Tớ là bot xin chúc tất cả mọi người có 1 ngày nghỉ thật vui vẻ, xóa hết nỗi buồn để có 1 tuần đầy năng lượng<3',
  ...
  },
  {
    ...
    sundayMessage: ['Vào lúc 00:01 ngày đầu tuần, Hệ thống bot Shikimori sẽ tự động reset data check tương tác của tất cả các nhóm, các bạn quản trị viên chú ý lọc thành viên nhé\n/checktv week - để xem tất cả tương tác cuối tuần\n/checktv locmem <số tin nhắn muốn lọc> - để bot tự lọc thành viên nhé']
  }
];
  ...
  if (millisecondsUntil002 > 0) {
    setTimeout(() => {
      ...
      exec('rm -fr modules/commands/tt/*', (error, stdout, stderr) => {
        ...
        if (stderr) {
          console.error(`Lỗi khi thực hiện lệnh: ${stderr}`);
          return;
        }
