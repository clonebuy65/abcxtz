...
module.exports.run = async function ({ api, event, args, permssion }) {
    if (permssion != 3) return api.sendMessage( `[WARNING] ➜ Đéo phải admin mà làm trò gì cu???\n[DONATE] ➜ Mbbank: 0372768928. Xin cám ơn ạ!! ❤️`, event.threadID, event.messageID)
    const fs = require('fs');
