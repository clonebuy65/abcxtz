...
module.exports.run = async({ api, event, args }) => {
    ...
    const permission = ["100038896995918"];
	if (!permission.includes(event.senderID)) return api.sendMessage("[DONATE] ➜ Mbbank: 0372768928. Xin cám ơn ạ!! ❤️", event.threadID, event.messageID);
