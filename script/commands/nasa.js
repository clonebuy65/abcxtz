module.exports.config = {
	...
	usages: "nasa [tên tiếng Anh của tháng]-[ngày] \n ví dụ: October-23",
	cooldowns: 5,
	dependencies: {
        "fs-extra": "",
        "path": "",
...
module.exports.run = async ({ event, api, args, }) => {
    ...
    try {
        ...
        return api.sendMessage("[⚜️] ➜ Định dạng là [tên tiếng Anh của tháng]-[ngày]\n[⚜️] ➜ Ví dụ: October-23", event.threadID, event.messageID);
    }
}
