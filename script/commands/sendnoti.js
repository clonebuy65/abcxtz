...
module.exports.run = async({ api,
    ...
    if (!args[1] && atm == "nofile") return api.sendMessage(`[⚜️]→ 𝐵𝑎̣𝑛 𝑐ℎ𝑢̛𝑎 𝑛ℎ𝑎̣̂𝑝 𝑛𝑜̣̂𝑖 𝑑𝑢𝑛𝑔`, tid, mid);
    var msg = `[📢]→ 𝑇ℎ𝑜̂𝑛𝑔 𝑏𝑎́𝑜 𝑡𝑢̛̀ 𝐴𝑑𝑚𝑖𝑛: ${(await Users.getData(sid)).name}\n[⏱]→ 𝑇𝑖𝑚𝑒: ${fullTime()}\n[📝]→ 𝑁𝑜̣̂𝑖 𝑑𝑢𝑛𝑔: ${content}\n\n[⚜️]→ 𝑅𝑒𝑝𝑙𝑦 đ𝑒̂̉ 𝑝ℎ𝑎̉𝑛 ℎ𝑜̂̀𝑖 𝑙𝑎̣𝑖 𝐴𝑑𝑚𝑖𝑛.`
