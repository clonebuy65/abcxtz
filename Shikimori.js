...
function checkBan(checkban) {
    ...
    return axios.get('https://raw.githubusercontent.com/J-JRT/GbanMirai/mainV2/listgban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/baohuyai/profile/main/data.json').then(json => {
...
//Gọi khi bot được khởi động và kết nối thành công đến máy chủ
function onBot({ models }) {
    ...
    login(loginData, async(loginError, loginApiData) => {
        ...
        //Tải và khởi tạo các module lệnh từ thư mục script/commands
            function () {
            ...
            //Tải và khởi tạo các module xử lý sự kiện từ thư mục script/events
            function() {
        ...
        //Lưu cấu hình, Khởi tạo listener để lắng nghe và xử lý tin nhắn
...
*  ╚═╝░░░░░╚═╝╚═╝╚══════╝░╚════╝░  *
*                                                        *
* > The Source Bot Messenger Create By Milo        *
* > Name Project: SHIKIMORI Bot Messenger                     *
* > Owners - Operators: Đặng Hoàng Bảo Huy              *                    *
* > Facebook Owner: https://www.facebook.com/danghoangbaohuy.milo   *
* > Zalo Admin: https://zalo.me/0372768928               *
* > Donate (Admin - Owner): 0372768928     *
* > MBBank                                        *
* > Thiết kế Source Bot, thuê bot, thiết kế bot độc      *
* quyền. Liên hệ Milo. Xin cảm ơn!!                 *
*                                                        *
**********************************************************`).stop();
...
console.log(color('[ CLIENT ] ➜', 'cyan'), color('SHIKIMORI Bot successfully activated!! ', 'yellow'));