...
module.exports.run = async function({ api, event, args, Users }) {
    ...
    try {
        switch(args[0]) {
            ...
            case "shop":
                return await api.sendMessage("=== 『 SHOP MONSTER 』 ===\n━━━━━━━━━━━━━━━━\n[⚜️] ➜ Lựa chọn:\n1. Mua vũ khí🗡\n2. Mua thức ăn🍗\n3. Bán quái vật💵\n\n[⚜️] ➜ Reply theo stt để chọn", event.threadID, (err, info) => {
            ...
            case "fix":
                ...
                return api.sendMessage({ body: `[⚜️] ➜ Lưu ý: chỉ được sửa độ bền của vũ khí đang sử dụng!\n[⚜️] ➜ Độ bền tối đa 10.000/1 vũ khí`, attachment: stream }, event.threadID, (err, info) => {
                    global.client.handleReply.push({
                        name: 'monster',
                        messageID: info.messageID,
                        author: event.senderID,
