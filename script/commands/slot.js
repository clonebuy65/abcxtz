...
module.exports.languages = {
    ...
    "en": {
        ...
        "moneyBetNotEnough": "[⚜️]➜ The money you betted is bigger than your balance!",
        "limitBet": "[⚜️]➜ Your bet is too low, the minimum is 50$",
        "returnWin": "🎰 %1 | %2 | %3 🎰\nYou won with %4$",
        "returnLose": "🎰 %1 | %2 | %3 🎰\nYou lost and loss %4$"
    }
}
...
module.exports.run = async function({ api, event, args, Currencies, getText }) {
   ...
   if(number[0] == "7⃣" && number[1] == "7⃣" && number[2] == "7⃣"){
    ...
    switch (win) {
        case true: {
          api.sendMessage({
            body: `[⚜️]=== 『 PLAY SLOT 』 ===[⚜️]\n◆━━━━━━━━━━━━━━━━◆\n\n[⚜️]➜ Kết quả slot: ${slotItems[number[0]]} | ${slotItems[number[1]]} | ${slotItems[number[2]]}\n[⚜️]➜ Bạn đã thắng: +${moneyBet}$`, 
            attachment: img
          }, threadID, messageID)
