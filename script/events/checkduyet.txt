...
module.exports.run = async function({
    ...
    if (logMessageData.addedParticipants.find(i => i.userFbId == botID())) {
        send("[⚜️] ➜ 𝐂𝐡𝐞𝐜𝐤 𝐭𝐡𝐞 𝐚𝐩𝐩𝐫𝐨𝐯𝐞𝐝 𝐥𝐢𝐬𝐭...", event.threadID, (error, info) => {
            setTimeout(function() {
                unsend(info.messageID)
                if (!data.includes(threadID)) send("[⚜️] ➜ 𝐊𝐞̂́𝐭 𝐧𝐨̂́𝐢 𝐭𝐡𝐚̂́𝐭 𝐛𝐚̣𝐢, 𝐧𝐡𝐨́𝐦 𝐛𝐚̣𝐧 𝐜𝐡𝐮̛𝐚 𝐝𝐮̛𝐨̛̣𝐜 𝐝𝐮𝐲𝐞̣̂𝐭 𝐝𝐞̂̉ 𝐠𝐮̛̉𝐢 𝐲𝐞̂𝐮 𝐜𝐚̂̀𝐮 𝐠𝐡𝐢 'JRT' 𝐥𝐚̀ 𝐬𝐞̃ đ𝐮̛𝐨̛̣𝐜 𝐝𝐮𝐲𝐞̣̂𝐭 !!!", threadID)
                else send(`[🍎] ➜ 𝐊𝐞̂́𝐭 𝐧𝐨̂́𝐢 𝐝𝐞̂́𝐧 𝐧𝐡𝐨́𝐦 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠!.\n[🦄] ➜ ℎ𝑎̃𝑦 𝑏𝑎̆́𝑡 𝑑𝑎̂̀𝑢 𝑣𝑜̛́𝑖 𝑛ℎ𝑢̛̃𝑛𝑔 𝑙𝑒̣̂𝑛ℎ 𝑑𝑢̛𝑜̛́𝑖 𝑑𝑎̂𝑦 𝑑𝑒̂̉ 𝑙𝑎̀𝑚 𝑞𝑢𝑒𝑛 𝑛ℎ𝑒́!\n༒───────⑄───────༒\n[👉] ➜ ${PREFIX}help (𝕏𝕖𝕞 𝕕𝕒𝕟𝕙 𝕤𝕒́𝕔𝕙 𝕥𝕠𝕒̀𝕟 𝕓𝕠̣̂ 𝕝𝕖̣̂𝕟𝕙)`, threadID)
            }, 5000);
        })
    } else return
}